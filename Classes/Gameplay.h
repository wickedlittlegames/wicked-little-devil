...
@interface Gameplay : CCLayer 
{
	...
	int difToInt, scoreInt, highScore, ptime, btime,btype,godpower,godpowerType,dtime,bonusScore;
}

@property (nonatomic) int difToInt, scoreInt, highScore, ptime, etime, btime, btype,godpower,godpowerType,dtime, bonusScore;
